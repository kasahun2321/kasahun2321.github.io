...
<html lang="en">
  <head>
    ...
    <link href="<?php echo site_url('assets/font-awesome/css/font-awesome.mini.css'); ?>" rel="stylesheet"> 
  ...
  <div class="container">
   ...
   <li>
    <?php
          ...
          <ul class="nav navbar-nav navbar-right header-buttons">
          <!--upto  here we will remove later--->
   <li><?php echo anchor('post', 'Post announcment', 'class="btn btn-default text-black"'); ?></li>       
          </ul>    
